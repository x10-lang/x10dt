...
/**
 * Timeout class that has constants for all timeout values that are multiplied by a multiplier.
 * The multiplier can be changed by changing the java system property "com.ibm.etools.swtbot.multiplier",
 * so slower machines or slower connections can change all timeout values by changing the system property.
 */
