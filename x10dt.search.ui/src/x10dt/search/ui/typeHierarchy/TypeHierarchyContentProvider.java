...
//		fMethodOverrideTester= null;
		fTypeHierarchyLifeCycleListener= new ITypeHierarchyLifeCycleListener() {
			public void typeHierarchyChanged(TypeHierarchyLifeCycle typeHierarchyProvider, ITypeInfo[] changedTypes) {
...
//	private boolean initializeMethodOverrideTester(IMethod filterMethod, ITypeInfo typeToFindIn) {
...
//	private void addCompatibleMethods(IMethod filterMethod, ITypeInfo typeToFindIn, List children) throws Exception {
...
//	private boolean hasCompatibleMethod(IMethod filterMethod, ITypeInfo typeToFindIn) throws Exception {
//		boolean filterMethodOverrides= initializeMethodOverrideTester(filterMethod, typeToFindIn);
//		IMethod[] methods= typeToFindIn.getMethods();
//		for (int i= 0; i < methods.length; i++) {
...
//	private boolean isCompatibleMethod(IMethod filterMethod, IMethod method, boolean filterOverrides) throws Exception {
//		if (filterOverrides) {
...
//	}
	 ...
	 */
	protected abstract ITypeInfo getParentType(ITypeInfo type);
...
//		ISourceEntity input= fTypeHierarchy.getInputElement();
//		int inputType= input.getElementType();
//		if (inputType ==  ISourceEntity.TYPE) {
//			return true;
//		}
//
//		ISourceEntity parent= type.getAncestor(input.getElementType());
//		if (inputType == ISourceEntity.PACKAGE_FRAGMENT) {
...
//			if (member.getElementType() == ISourceEntity.TYPE) {
