...
class ArrayIndexOutOfBoundsException : public x10::lang::RuntimeException
  {
    ...
    virtual x10aux::ref<x10::lang::ArrayIndexOutOfBoundsException> x10__lang__ArrayIndexOutOfBoundsException____x10__lang__ArrayIndexOutOfBoundsException__this(
      );
