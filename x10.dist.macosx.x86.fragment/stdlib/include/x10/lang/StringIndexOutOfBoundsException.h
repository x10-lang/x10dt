...
class StringIndexOutOfBoundsException : public x10::lang::RuntimeException
  {
    public:
    RTT_H_DECLS_CLASS
    ...
    static x10aux::ref<x10::lang::StringIndexOutOfBoundsException> _make(
             );
    ...
    virtual x10aux::ref<x10::lang::StringIndexOutOfBoundsException> x10__lang__StringIndexOutOfBoundsException____x10__lang__StringIndexOutOfBoundsException__this(
      );
...
template<class __T> x10aux::ref<__T> x10::lang::StringIndexOutOfBoundsException::_deserializer(x10aux::deserialization_buffer& buf) {
    x10aux::ref<x10::lang::StringIndexOutOfBoundsException> this_ = new (memset(x10aux::alloc<x10::lang::StringIndexOutOfBoundsException>(), 0, sizeof(x10::lang::StringIndexOutOfBoundsException))) x10::lang::StringIndexOutOfBoundsException();
