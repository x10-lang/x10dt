...
template<class FMGL(Key), class FMGL(Value)> class HashMap__EntrySet : public x10::util::AbstractCollection<x10aux::ref<x10::util::Map__Entry<FMGL(Key), FMGL(Value)> > >
  {
    ...
    virtual x10aux::ref<x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)> >
      x10__util__HashMap__EntrySet____x10__util__HashMap__EntrySet__this(
      );
...
template<class FMGL(Key), class FMGL(Value)> class x10_util_HashMap__EntrySet__closure__0 : public x10::lang::Closure {
    ...
    // closure body
    x10aux::ref<x10::util::Map__Entry<FMGL(Key), FMGL(Value)> > __apply(x10aux::ref<x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)> > e) {
        
        //#line 293 "/Users/rfuhrer/eclipse/workspaces/x10dt-trunk/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10Return_c
    ...
    template<class __T> static x10aux::ref<__T> _deserialize(x10aux::deserialization_buffer &buf) {
        x10_util_HashMap__EntrySet__closure__0<FMGL(Key),FMGL(Value) >* storage = x10aux::alloc<x10_util_HashMap__EntrySet__closure__0<FMGL(Key),FMGL(Value) > >();
        buf.record_reference(x10aux::ref<x10_util_HashMap__EntrySet__closure__0<FMGL(Key),FMGL(Value) > >(storage));
        x10aux::ref<x10_util_HashMap__EntrySet__closure__0<FMGL(Key),FMGL(Value) > > this_ = new (storage) x10_util_HashMap__EntrySet__closure__0<FMGL(Key),FMGL(Value) >();
        return this_;
    }
    ...
    const char* toNativeString() {
        return "/Users/rfuhrer/eclipse/workspaces/x10dt-trunk/x10.runtime/src-x10/x10/util/HashMap.x10:293";
    }

};

template<class FMGL(Key), class FMGL(Value)> typename x10::lang::Fun_0_1<x10aux::ref<x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)> >, x10aux::ref<x10::util::Map__Entry<FMGL(Key), FMGL(Value)> > >::template itable <x10_util_HashMap__EntrySet__closure__0<FMGL(Key),FMGL(Value) > >x10_util_HashMap__EntrySet__closure__0<FMGL(Key),FMGL(Value) >::_itable(&x10::lang::Reference::equals, &x10::lang::Closure::hashCode, &x10_util_HashMap__EntrySet__closure__0<FMGL(Key),FMGL(Value) >::__apply, &x10_util_HashMap__EntrySet__closure__0<FMGL(Key),FMGL(Value) >::toString, &x10::lang::Closure::typeName);template<class FMGL(Key), class FMGL(Value)>
...
const x10aux::serialization_id_t x10_util_HashMap__EntrySet__closure__0<FMGL(Key),FMGL(Value) >::_serialization_id = 
    x10aux::DeserializationDispatcher::addDeserializer(x10_util_HashMap__EntrySet__closure__0<FMGL(Key),FMGL(Value) >::template _deserialize<x10::lang::Reference>,x10aux::CLOSURE_KIND_NOT_ASYNC);
...
template<class FMGL(Key), class FMGL(Value)> typename x10::util::Container<x10aux::ref<x10::util::Map__Entry<FMGL(Key), FMGL(Value)> > >::template itable<x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)> >  x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::_itable_0(&x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::clone, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::contains, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::containsAll, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::equals, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::hashCode, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::isEmpty, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::iterator, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::size, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::toRail, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::toString, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::typeName);
template<class FMGL(Key), class FMGL(Value)> x10::lang::Any::itable<x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)> >  x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::_itable_1(&x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::equals, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::hashCode, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::toString, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::typeName);
template<class FMGL(Key), class FMGL(Value)> typename x10::lang::Iterable<x10aux::ref<x10::util::Map__Entry<FMGL(Key), FMGL(Value)> > >::template itable<x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)> >  x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::_itable_2(&x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::equals, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::hashCode, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::iterator, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::toString, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::typeName);
template<class FMGL(Key), class FMGL(Value)> typename x10::util::Collection<x10aux::ref<x10::util::Map__Entry<FMGL(Key), FMGL(Value)> > >::template itable<x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)> >  x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::_itable_3(&x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::add, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::addAll, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::addAllWhere, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::clear, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::clone, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::contains, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::containsAll, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::equals, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::hashCode, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::isEmpty, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::iterator, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::remove, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::removeAll, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::removeAllWhere, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::retainAll, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::size, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::toRail, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::toString, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::typeName);
template<class FMGL(Key), class FMGL(Value)> typename x10::util::Set<x10aux::ref<x10::util::Map__Entry<FMGL(Key), FMGL(Value)> > >::template itable<x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)> >  x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::_itable_4(&x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::add, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::addAll, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::addAllWhere, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::clear, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::clone, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::contains, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::containsAll, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::equals, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::hashCode, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::isEmpty, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::iterator, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::remove, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::removeAll, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::removeAllWhere, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::retainAll, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::size, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::toRail, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::toString, &x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::typeName);
...
//#line 287 "/Users/rfuhrer/eclipse/workspaces/x10dt-trunk/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10FieldDecl_c

//#line 289 "/Users/rfuhrer/eclipse/workspaces/x10dt-trunk/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10ConstructorDecl_c
                                               ...
                                               x10aux::ref<x10::util::HashMap<FMGL(Key), FMGL(Value)> > map)
{
    ...
    //#line 289 "/Users/rfuhrer/eclipse/workspaces/x10dt-trunk/x10.runtime/src-x10/x10/util/HashMap.x10": polyglot.ast.Eval_c
    ((x10aux::ref<x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)> >)this)->
      FMGL(map) =
      map;
...
//#line 291 "/Users/rfuhrer/eclipse/workspaces/x10dt-trunk/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10MethodDecl_c
template<class FMGL(Key), class FMGL(Value)> x10aux::ref<x10::lang::Iterator<x10aux::ref<x10::util::Map__Entry<FMGL(Key), FMGL(Value)> > > >
  x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::iterator(
  ) {
    
    //#line 292 "/Users/rfuhrer/eclipse/workspaces/x10dt-trunk/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10Return_c
...
//#line 296 "/Users/rfuhrer/eclipse/workspaces/x10dt-trunk/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10MethodDecl_c
template<class FMGL(Key), class FMGL(Value)>
x10_boolean
  x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::contains(
  x10aux::ref<x10::util::Map__Entry<FMGL(Key), FMGL(Value)> > k) {
    
    //#line 296 "/Users/rfuhrer/eclipse/workspaces/x10dt-trunk/x10.runtime/src-x10/x10/util/HashMap.x10": polyglot.ast.Throw_c
    x10aux::throwException(x10aux::nullCheck(x10::lang::UnsupportedOperationException::_make()));
}

//#line 297 "/Users/rfuhrer/eclipse/workspaces/x10dt-trunk/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10MethodDecl_c
template<class FMGL(Key), class FMGL(Value)>
x10_boolean
  x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::add(
  x10aux::ref<x10::util::Map__Entry<FMGL(Key), FMGL(Value)> > k) {
    
    //#line 297 "/Users/rfuhrer/eclipse/workspaces/x10dt-trunk/x10.runtime/src-x10/x10/util/HashMap.x10": polyglot.ast.Throw_c
    x10aux::throwException(x10aux::nullCheck(x10::lang::UnsupportedOperationException::_make()));
}

//#line 298 "/Users/rfuhrer/eclipse/workspaces/x10dt-trunk/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10MethodDecl_c
template<class FMGL(Key), class FMGL(Value)>
x10_boolean
  x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::remove(
  x10aux::ref<x10::util::Map__Entry<FMGL(Key), FMGL(Value)> > k) {
    
    //#line 298 "/Users/rfuhrer/eclipse/workspaces/x10dt-trunk/x10.runtime/src-x10/x10/util/HashMap.x10": polyglot.ast.Throw_c
    x10aux::throwException(x10aux::nullCheck(x10::lang::UnsupportedOperationException::_make()));
}

//#line 299 "/Users/rfuhrer/eclipse/workspaces/x10dt-trunk/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10MethodDecl_c
template<class FMGL(Key), class FMGL(Value)>
x10aux::ref<x10::util::Container<x10aux::ref<x10::util::Map__Entry<FMGL(Key), FMGL(Value)> > > >
  x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::clone(
    ...
    //#line 299 "/Users/rfuhrer/eclipse/workspaces/x10dt-trunk/x10.runtime/src-x10/x10/util/HashMap.x10": polyglot.ast.Throw_c
    x10aux::throwException(x10aux::nullCheck(x10::lang::UnsupportedOperationException::_make()));
}

//#line 300 "/Users/rfuhrer/eclipse/workspaces/x10dt-trunk/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10MethodDecl_c
template<class FMGL(Key), class FMGL(Value)>
x10_int
  x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::size(
  ) {
    
    //#line 300 "/Users/rfuhrer/eclipse/workspaces/x10dt-trunk/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10Return_c
    return x10aux::nullCheck(((x10aux::ref<x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)> >)this)->
                               FMGL(map))->size();
    
}

//#line 284 "/Users/rfuhrer/eclipse/workspaces/x10dt-trunk/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10MethodDecl_c
template<class FMGL(Key), class FMGL(Value)>
x10aux::ref<x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)> >
  x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::x10__util__HashMap__EntrySet____x10__util__HashMap__EntrySet__this(
  ) {
    
    //#line 284 "/Users/rfuhrer/eclipse/workspaces/x10dt-trunk/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10Return_c
    return ((x10aux::ref<x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)> >)this);
    
}
template<class FMGL(Key), class FMGL(Value)>
const x10aux::serialization_id_t x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::_serialization_id = 
    x10aux::DeserializationDispatcher::addDeserializer(x10::util::HashMap__EntrySet<FMGL(Key), FMGL(Value)>::template _deserializer<x10::lang::Reference>, x10aux::CLOSURE_KIND_NOT_ASYNC);
