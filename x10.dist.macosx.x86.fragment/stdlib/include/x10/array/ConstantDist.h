#ifndef __X10_ARRAY_CONSTANTDIST_H
#define __X10_ARRAY_CONSTANTDIST_H
...
class ConstantDist : public x10::array::Dist   {
    public:
    RTT_H_DECLS_CLASS
    ...
    static x10::lang::Fun_0_1<x10aux::ref<x10::array::Point>, x10::lang::Place>::itable<x10::array::ConstantDist > _itable_0;
    
    static x10::lang::Any::itable<x10::array::ConstantDist > _itable_1;
    
    static x10::lang::Iterable<x10aux::ref<x10::array::Point> >::itable<x10::array::ConstantDist > _itable_2;
    
    void _instance_init();
    
    void _constructor(x10aux::ref<x10::array::Region> r, x10::lang::Place p);
    
    static x10aux::ref<x10::array::ConstantDist> _make(x10aux::ref<x10::array::Region> r,
                                                       x10::lang::Place p);
    ...
    virtual x10aux::ref<x10::array::ConstantDist> x10__array__ConstantDist____x10__array__ConstantDist__this(
      );
...
#endif // X10_ARRAY_CONSTANTDIST_H

namespace x10 { namespace array { 
class ConstantDist;
} } 

#ifndef X10_ARRAY_CONSTANTDIST_H_NODEPS
#define X10_ARRAY_CONSTANTDIST_H_NODEPS
#include <x10/array/Dist.h>
...
#ifndef X10_ARRAY_CONSTANTDIST_H_GENERICS
#define X10_ARRAY_CONSTANTDIST_H_GENERICS
template<class __T> x10aux::ref<__T> x10::array::ConstantDist::_deserializer(x10aux::deserialization_buffer& buf) {
    x10aux::ref<x10::array::ConstantDist> this_ = new (memset(x10aux::alloc<x10::array::ConstantDist>(), 0, sizeof(x10::array::ConstantDist))) x10::array::ConstantDist();
    buf.record_reference(this_);
    this_->_deserialize_body(buf);
    return this_;
}

#endif // X10_ARRAY_CONSTANTDIST_H_GENERICS
#endif // __X10_ARRAY_CONSTANTDIST_H_NODEPS
