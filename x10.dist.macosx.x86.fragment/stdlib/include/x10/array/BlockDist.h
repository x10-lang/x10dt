#ifndef __X10_ARRAY_BLOCKDIST_H
#define __X10_ARRAY_BLOCKDIST_H
...
class BlockDist : public x10::array::Dist   {
    public:
    RTT_H_DECLS_CLASS
    ...
    static x10::lang::Fun_0_1<x10aux::ref<x10::array::Point>, x10::lang::Place>::itable<x10::array::BlockDist > _itable_0;
    
    static x10::lang::Any::itable<x10::array::BlockDist > _itable_1;
    
    static x10::lang::Iterable<x10aux::ref<x10::array::Point> >::itable<x10::array::BlockDist > _itable_2;
    ...
    void _constructor(x10aux::ref<x10::array::Region> r, x10_int axis, x10aux::ref<x10::array::PlaceGroup> pg);
    
    static x10aux::ref<x10::array::BlockDist> _make(x10aux::ref<x10::array::Region> r,
                                                    x10_int axis,
                                                    x10aux::ref<x10::array::PlaceGroup> pg);
    
    x10aux::ref<x10::array::Region> blockRegionForPlace(x10::lang::Place place);
    x10::lang::Place mapIndexToPlace(x10_int index);
    ...
    virtual x10aux::ref<x10::array::BlockDist> x10__array__BlockDist____x10__array__BlockDist__this(
      );
    void __fieldInitializers1206();
...
#endif // X10_ARRAY_BLOCKDIST_H

namespace x10 { namespace array { 
class BlockDist;
} } 

#ifndef X10_ARRAY_BLOCKDIST_H_NODEPS
#define X10_ARRAY_BLOCKDIST_H_NODEPS
#include <x10/array/Dist.h>
...
#ifndef X10_ARRAY_BLOCKDIST_H_GENERICS
#define X10_ARRAY_BLOCKDIST_H_GENERICS
template<class __T> x10aux::ref<__T> x10::array::BlockDist::_deserializer(x10aux::deserialization_buffer& buf) {
    x10aux::ref<x10::array::BlockDist> this_ = new (memset(x10aux::alloc<x10::array::BlockDist>(), 0, sizeof(x10::array::BlockDist))) x10::array::BlockDist();
    buf.record_reference(this_);
    this_->_deserialize_body(buf);
    return this_;
}

#endif // X10_ARRAY_BLOCKDIST_H_GENERICS
#endif // __X10_ARRAY_BLOCKDIST_H_NODEPS
