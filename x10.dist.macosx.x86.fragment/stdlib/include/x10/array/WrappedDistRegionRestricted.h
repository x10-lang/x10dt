#ifndef __X10_ARRAY_WRAPPEDDISTREGIONRESTRICTED_H
#define __X10_ARRAY_WRAPPEDDISTREGIONRESTRICTED_H
...
class WrappedDistRegionRestricted : public x10::array::Dist   {
    public:
    RTT_H_DECLS_CLASS
    ...
    static x10::lang::Fun_0_1<x10aux::ref<x10::array::Point>, x10::lang::Place>::itable<x10::array::WrappedDistRegionRestricted > _itable_0;
    
    static x10::lang::Any::itable<x10::array::WrappedDistRegionRestricted > _itable_1;
    
    static x10::lang::Iterable<x10aux::ref<x10::array::Point> >::itable<x10::array::WrappedDistRegionRestricted > _itable_2;
    
    void _instance_init();
    
    x10aux::ref<x10::array::Dist> FMGL(base);
    
    x10aux::ref<x10::array::Region> FMGL(filter);
    
    void _constructor(x10aux::ref<x10::array::Dist> d, x10aux::ref<x10::array::Region> r);
    
    static x10aux::ref<x10::array::WrappedDistRegionRestricted> _make(x10aux::ref<x10::array::Dist> d,
    ...
    virtual x10aux::ref<x10::array::WrappedDistRegionRestricted> x10__array__WrappedDistRegionRestricted____x10__array__WrappedDistRegionRestricted__this(
      );
...
#endif // X10_ARRAY_WRAPPEDDISTREGIONRESTRICTED_H

namespace x10 { namespace array { 
class WrappedDistRegionRestricted;
} } 

#ifndef X10_ARRAY_WRAPPEDDISTREGIONRESTRICTED_H_NODEPS
#define X10_ARRAY_WRAPPEDDISTREGIONRESTRICTED_H_NODEPS
#include <x10/array/Dist.h>
...
#ifndef X10_ARRAY_WRAPPEDDISTREGIONRESTRICTED_H_GENERICS
#define X10_ARRAY_WRAPPEDDISTREGIONRESTRICTED_H_GENERICS
template<class __T> x10aux::ref<__T> x10::array::WrappedDistRegionRestricted::_deserializer(x10aux::deserialization_buffer& buf) {
    x10aux::ref<x10::array::WrappedDistRegionRestricted> this_ = new (memset(x10aux::alloc<x10::array::WrappedDistRegionRestricted>(), 0, sizeof(x10::array::WrappedDistRegionRestricted))) x10::array::WrappedDistRegionRestricted();
    buf.record_reference(this_);
    this_->_deserialize_body(buf);
    return this_;
}

#endif // X10_ARRAY_WRAPPEDDISTREGIONRESTRICTED_H_GENERICS
#endif // __X10_ARRAY_WRAPPEDDISTREGIONRESTRICTED_H_NODEPS
