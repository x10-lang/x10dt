...
class FullRegion : public x10::array::Region   {
    ...
    virtual x10_int indexOf(x10aux::ref<x10::array::Point> id__45);
    ...
    virtual x10aux::ref<x10::array::FullRegion> x10__array__FullRegion____x10__array__FullRegion__this(
      );
