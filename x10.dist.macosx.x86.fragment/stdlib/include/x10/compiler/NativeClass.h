...
class NativeClass   {
    ...
    template <class I> struct itable {
        itable(x10aux::ref<x10::lang::String> (I::*className) (), x10_boolean (I::*equals) (x10aux::ref<x10::lang::Any>), x10_int (I::*hashCode) (), x10aux::ref<x10::lang::String> (I::*lang) (), x10aux::ref<x10::lang::String> (I::*packageName) (), x10aux::ref<x10::lang::String> (I::*toString) (), x10aux::ref<x10::lang::String> (I::*typeName) ()) : className(className), equals(equals), hashCode(hashCode), lang(lang), packageName(packageName), toString(toString), typeName(typeName) {}
    ...
    template <class R> static x10aux::ref<x10::lang::String> className(x10aux::ref<R> _recv) {
        x10aux::ref<x10::lang::Reference> _refRecv(_recv);
        return (_refRecv.operator->()->*(x10aux::findITable<x10::compiler::NativeClass>(_refRecv->_getITables())->className))();
    }
    template <class R> static x10aux::ref<x10::lang::String> className(R _recv) {
        return R::_METHODS::className(_recv);
    }
    template <class R> static x10_boolean equals(x10aux::ref<R> _recv, x10aux::ref<x10::lang::Any> arg0) {
        x10aux::ref<x10::lang::Reference> _refRecv(_recv);
        return (_refRecv.operator->()->*(x10aux::findITable<x10::compiler::NativeClass>(_refRecv->_getITables())->equals))(arg0);
    }
    ...
    template <class R> static x10_int hashCode(x10aux::ref<R> _recv) {
        x10aux::ref<x10::lang::Reference> _refRecv(_recv);
        return (_refRecv.operator->()->*(x10aux::findITable<x10::compiler::NativeClass>(_refRecv->_getITables())->hashCode))();
    }
    ...
    template <class R> static x10aux::ref<x10::lang::String> lang(x10aux::ref<R> _recv) {
        x10aux::ref<x10::lang::Reference> _refRecv(_recv);
        return (_refRecv.operator->()->*(x10aux::findITable<x10::compiler::NativeClass>(_refRecv->_getITables())->lang))();
    }
    template <class R> static x10aux::ref<x10::lang::String> lang(R _recv) {
        return R::_METHODS::lang(_recv);
    }
    template <class R> static x10aux::ref<x10::lang::String> packageName(x10aux::ref<R> _recv) {
        x10aux::ref<x10::lang::Reference> _refRecv(_recv);
        return (_refRecv.operator->()->*(x10aux::findITable<x10::compiler::NativeClass>(_refRecv->_getITables())->packageName))();
    }
    template <class R> static x10aux::ref<x10::lang::String> packageName(R _recv) {
        return R::_METHODS::packageName(_recv);
    }
    template <class R> static x10aux::ref<x10::lang::String> toString(x10aux::ref<R> _recv) {
        x10aux::ref<x10::lang::Reference> _refRecv(_recv);
        return (_refRecv.operator->()->*(x10aux::findITable<x10::compiler::NativeClass>(_refRecv->_getITables())->toString))();
    }
    ...
    template <class R> static x10aux::ref<x10::lang::String> typeName(x10aux::ref<R> _recv) {
        x10aux::ref<x10::lang::Reference> _refRecv(_recv);
        return (_refRecv.operator->()->*(x10aux::findITable<x10::compiler::NativeClass>(_refRecv->_getITables())->typeName))();
    }
