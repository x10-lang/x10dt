#ifndef __X10_COMPILER_TEMPNOINLINE_2_H
#define __X10_COMPILER_TEMPNOINLINE_2_H
...
class TempNoInline_2   {
    ...
    template <class R> static x10_boolean equals(x10aux::ref<R> _recv, x10aux::ref<x10::lang::Any> arg0) {
        ...
        return (_refRecv.operator->()->*(x10aux::findITable<x10::compiler::TempNoInline_2>(_refRecv->_getITables())->equals))(arg0);
    }
    ...
    template <class R> static x10_int hashCode(x10aux::ref<R> _recv) {
        x10aux::ref<x10::lang::Reference> _refRecv(_recv);
        return (_refRecv.operator->()->*(x10aux::findITable<x10::compiler::TempNoInline_2>(_refRecv->_getITables())->hashCode))();
    }
    ...
    template <class R> static x10aux::ref<x10::lang::String> toString(x10aux::ref<R> _recv) {
        x10aux::ref<x10::lang::Reference> _refRecv(_recv);
        return (_refRecv.operator->()->*(x10aux::findITable<x10::compiler::TempNoInline_2>(_refRecv->_getITables())->toString))();
    }
    ...
    template <class R> static x10aux::ref<x10::lang::String> typeName(x10aux::ref<R> _recv) {
        x10aux::ref<x10::lang::Reference> _refRecv(_recv);
        return (_refRecv.operator->()->*(x10aux::findITable<x10::compiler::TempNoInline_2>(_refRecv->_getITables())->typeName))();
    }
...
#endif // X10_COMPILER_TEMPNOINLINE_2_H

namespace x10 { namespace compiler { 
class TempNoInline_2;
} } 

#ifndef X10_COMPILER_TEMPNOINLINE_2_H_NODEPS
#define X10_COMPILER_TEMPNOINLINE_2_H_NODEPS
#include <x10/lang/Any.h>
#include <x10/compiler/NoInline.h>
#ifndef X10_COMPILER_TEMPNOINLINE_2_H_GENERICS
#define X10_COMPILER_TEMPNOINLINE_2_H_GENERICS
#endif // X10_COMPILER_TEMPNOINLINE_2_H_GENERICS
#endif // __X10_COMPILER_TEMPNOINLINE_2_H_NODEPS
