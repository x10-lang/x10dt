...
class Ephemeral   {
    ...
    template <class R> static x10_boolean equals(x10aux::ref<R> _recv, x10aux::ref<x10::lang::Any> arg0) {
        ...
        return (_refRecv.operator->()->*(x10aux::findITable<x10::compiler::Ephemeral>(_refRecv->_getITables())->equals))(arg0);
    }
    ...
    template <class R> static x10_int hashCode(x10aux::ref<R> _recv) {
        x10aux::ref<x10::lang::Reference> _refRecv(_recv);
        return (_refRecv.operator->()->*(x10aux::findITable<x10::compiler::Ephemeral>(_refRecv->_getITables())->hashCode))();
    }
    ...
    template <class R> static x10aux::ref<x10::lang::String> toString(x10aux::ref<R> _recv) {
        x10aux::ref<x10::lang::Reference> _refRecv(_recv);
        return (_refRecv.operator->()->*(x10aux::findITable<x10::compiler::Ephemeral>(_refRecv->_getITables())->toString))();
    }
    ...
    template <class R> static x10aux::ref<x10::lang::String> typeName(x10aux::ref<R> _recv) {
        x10aux::ref<x10::lang::Reference> _refRecv(_recv);
        return (_refRecv.operator->()->*(x10aux::findITable<x10::compiler::Ephemeral>(_refRecv->_getITables())->typeName))();
    }
