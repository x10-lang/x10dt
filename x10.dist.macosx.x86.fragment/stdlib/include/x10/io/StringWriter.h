...
class StringWriter : public x10::io::Writer   {
    ...
    x10::lang::GlobalRef<x10aux::ref<x10::io::StringWriter> > FMGL(root);
    ...
    virtual void flush();
    virtual void close();
    virtual x10aux::ref<x10::io::StringWriter> x10__io__StringWriter____x10__io__StringWriter__this(
      );
    void __fieldInitializers1862();
    public: template<class FMGL(T2322)> void write(x10aux::ref<x10::io::Marshal<FMGL(T2322)> > p0, FMGL(T2322) p1);
...
template<class FMGL(T2322)> void x10::io::StringWriter::write(x10aux::ref<x10::io::Marshal<FMGL(T2322)> > p0, FMGL(T2322) p1) {
    x10::io::Writer::write<FMGL(T2322)>(p0, p1);
}
