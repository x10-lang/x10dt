...
/**
 * Defines the resource manager implementation for PAMI transport.
 * 
 * @author egeay
 */
public final class PAMIResourceManager extends AbstractX10ResourceManager implements IResourceManager {
   ...
   */
  public PAMIResourceManager(final PAMIResourceManagerConfiguration rmConfig, PAMIResourceManagerControl control, PAMIResourceManagerMonitor monitor) {
...
/*
  ...
  */
  ...
  protected IRuntimeSystem doCreateRuntimeSystem() throws CoreException {
    ...
    return new PAMIX10RuntimeSystem(Integer.parseInt(getID()), rmConfig);
  }
