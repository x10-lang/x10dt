 ...
 * @author egeay
 */
public final class PAMIResourceManager extends AbstractRuntimeResourceManager implements IResourceManager {
   ...
   */
  public PAMIResourceManager(final String id, final IPUniverseControl universe, 
