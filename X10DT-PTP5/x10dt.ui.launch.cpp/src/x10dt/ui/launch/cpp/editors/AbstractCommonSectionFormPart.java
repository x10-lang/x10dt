...
abstract class AbstractCommonSectionFormPart extends AbstractCompleteFormPart implements IFormPart {
  ...
  protected abstract void postPagesCreation();
  ...
  protected final ITargetOpHelper createTargetOpHelper() {
  ...
  protected final boolean handleEmptyComboValidation(final Combo combo, final String controlInfo) {
    final IFormControlChecker checker = FormCheckerFactory.createEmptyComboChecker(this.fFormPage, combo, controlInfo);
  ...
  protected final boolean handleLocalPathValidation(final Text text, final String pathSuffix, final String controlInfo) {
    ...
    String path = (pathSuffix != null && pathSuffix.length() > 0) ? fieldContents + File.separator + pathSuffix
                                                                 : fieldContents;
  ...
  class DirectoryDialogSelectionListener implements SelectionListener {
  ...
  class FileDialogSelectionListener implements SelectionListener {
