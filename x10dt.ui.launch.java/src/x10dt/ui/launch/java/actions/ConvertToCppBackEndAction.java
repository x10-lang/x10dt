 ...
 * @author egeay
 */
public final class ConvertToCppBackEndAction implements IObjectActionDelegate {
      ...
      for (final Iterator<?> it = ((IStructuredSelection) this.fCurSelection).iterator(); it.hasNext();) {
        ...
        try {
          ...
          final String[] natureIds = new String[] { 
            "x10dt.ui.launch.cpp.x10nature", SmapiProjectNature.k_natureID, JavaCore.NATURE_ID
          };
